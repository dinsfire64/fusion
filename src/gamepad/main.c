...
usb_desc_interface_c gamepad_interface = {
...
usb_hid_descriptor_c gamepad_hid_interface = {
...
usb_desc_endpoint_c gamepad_int_in = {
    .bLength = sizeof(struct usb_desc_endpoint),
    .bDescriptorType = USB_DESC_ENDPOINT,
    .bEndpointAddress = HID_GAMEPAD_EPINADDR,
    .bmAttributes = USB_XFER_INTERRUPT | USB_SYNC_NONE | USB_USAGE_DATA,
    .wMaxPacketSize = 32,
    .bInterval = 1,
};

usb_desc_endpoint_c lights_int_out = {
    .bLength = sizeof(struct usb_desc_endpoint),
    .bDescriptorType = USB_DESC_ENDPOINT,
    .bEndpointAddress = HID_LIGHTS_EPOUTADDR,
    .bmAttributes = USB_XFER_INTERRUPT | USB_SYNC_NONE | USB_USAGE_DATA,
    .wMaxPacketSize = 32,
    .bInterval = 1,
};
...
usb_configuration_c usb_config = {
    ...
    {
        {.interface = &gamepad_interface},
        {.generic = (struct usb_desc_generic *)&gamepad_hid_interface},
        {.endpoint = &gamepad_int_in},
        {.endpoint = &lights_int_out},
        {0},
    },
};
